...
\noindent Titre : Modélisation et agrégation d'un portefeuille de passifs en assurance vie : Effets sur le Best Estimate et le SCR
\\[0.3cm]
...
\noindent % Pour éviter un décalage horizontal au début
\begin{minipage}[t]{0.5\textwidth}
    \textit{Membres présents du jury de \\ l'Institut des Actuaires} \\[1.2cm]
    \fillin{6cm} \\[0.8cm]
    \fillin{6cm} \\[0.8cm]
    \fillin{6cm} \\[0.8cm]
...
\end{minipage}%
\begin{minipage}[t]{0.5\textwidth}
    \textit{Entreprise : Accenture} \\
    \textit{Nom : Makram Ben Dbabis} \\[0.3cm]
    \textit{Signature :} \\[0.5cm]
    \textit{Directeur de mémoire en entreprise :} \\
    \textit{Nom : Lucas Blancheton}  \\[0.3cm]
    \textit{Signature :} \\[0.5cm]
    \textit{Nom : Lionel Aldebert} \\[0.3cm]
    \textit{Signature :} \\[0.5cm]
    ...
    \framebox[7cm]{\rule{0mm}{1.5cm}} \\[0.3cm]
