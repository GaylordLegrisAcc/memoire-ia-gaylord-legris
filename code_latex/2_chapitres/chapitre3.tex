...
L'impossibilité technique de projeter individuellement chaque contrat au sein des modèles de gestion actif-passif (ALM), particulièrement gourmands en ressources computationnelles, fait de l'agrégation du passif un impératif incontournable pour le marché de l'assurance. Cette nécessité découle directement des exigences de réactivité lors des phases de clôture réglementaire Solvabilité 2, où la finesse de l'analyse des risques doit impérativement se concilier avec la performance d'exécution pour permettre le lancement de multiples sensibilités et scénarios économiques.
