...
\section{Approches déterministes classiques}
...
\subsection{Partitionnement en \textit{k}-moyennes (K-Means)}
...
\section{Approches basées sur l'analyse des flux financiers}
