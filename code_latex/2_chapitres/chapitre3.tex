...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{C:/Users/gaylord.legris/Repositories/generateur_passif_ep/variable_estimations/nb_asse_age/graphiques/distribution_age_assures.png}
...
\paragraph{Étape 3 et 4 : Comparaison et Sélection}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{C:/Users/gaylord.legris/Repositories/generateur_passif_ep/variable_estimations/nb_asse_age/graphiques/estimation_loi_gamma.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{C:/Users/gaylord.legris/Repositories/generateur_passif_ep/variable_estimations/nb_asse_age/graphiques/estimation_loi_beta.png}
...
Il est donc recommandé d'utiliser la \textbf{loi Gamma}, avec les paramètres estimés lors de l'analyse, pour toute application nécessitant une génération ou une représentation de l'âge des assurés.
\begin{itemize}
