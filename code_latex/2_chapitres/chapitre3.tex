...
\subsubsection{Variante « Smart Granular »}
Dans le cadre de l'optimisation, une variante nommée \textbf{Smart Granular} a été développée. Contrairement au Banding classique à pas constant, cette approche adapte la finesse des mailles selon la sensibilité locale des risques :
\begin{itemize}
    \item \textbf{Sur l'Âge :} Le pas est réduit à 1 an pour les assurés de plus de 60 ans (zone de forte courbure de la mortalité) et élargi à 5 ans pour les jeunes actifs.
    \item \textbf{Sur l'Ancienneté :} Le découpage est resserré précisément autour du seuil fiscal des 8 ans pour capturer la rupture de comportement des lois de rachat.
    \item \textbf{Sur le TMG :} Une segmentation stricte est maintenue pour éviter toute dilution des taux garantis.
\end{itemize}
