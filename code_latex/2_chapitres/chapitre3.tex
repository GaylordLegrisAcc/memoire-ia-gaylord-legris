...
\textcolor{blue}{Ici, on introduit les techniques transverses en préambule car elles servent à préparer la donnée pour ces algorithmes : Stratification Sexe/TMG, Feature Engineering (Log-PM).}
