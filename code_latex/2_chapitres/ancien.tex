...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/2_chapitres/chapitre1/alm_det.png}
...
\includegraphics[width=0.98\textwidth]{images/2_chapitres/chapitre1/modele_alm_sequence.png}
