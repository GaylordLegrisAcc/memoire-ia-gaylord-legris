...
Les rachats conjoncturels ne sont pas modélisés dans la version actuelle du modèle, mais pourraient être intégrés dans une version future pour simuler des comportements plus réalistes en fonction des conditions de marché. De même, la modélisation de la PB est actuellement basée sur une règle simple, mais pourrait être enrichie pour refléter des stratégies plus complexes.
