...
\usepackage{xcolor}
\definecolor{accCore1}{HTML}{A100FF}
\definecolor{accCore2}{HTML}{7500C0}
\definecolor{accCore3}{HTML}{460073}
\definecolor{acc1}{HTML}{B455AA}
\definecolor{acc2}{HTML}{A055F5}
\definecolor{acc3}{HTML}{BE82FF}
\definecolor{acc4}{HTML}{DCAFFF}
\definecolor{acc5}{HTML}{E6DCFF}
\usepackage{multirow}
\usepackage{eurosym}
\usepackage{siunitx}
...
\usetikzlibrary{positioning,decorations.pathreplacing,chains, decorations.pathreplacing, shapes.geometric, arrows.meta, shapes.misc, backgrounds, fit, shadows}
...
\titleformat{\chapter}[display]
  ...
  {\vspace*{50pt}\chaptertitlename\ \thechapter} 
  {25pt} 
  {\Huge} 
% Suppression du [\vfill\newpage] ici
% Redéfinition du format de section pour supprimer le saut de page
\titleformat{\section}
  {\normalfont\LARGE\bfseries} % Suppression de \cleardoublepage ici
  {\thesection}
  {1em}
  {}
